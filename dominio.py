...
class Leilao:
    ...
    #nao precisa trocar um por um, só trocar aqui
    # annotation/type hints = nao fica estaticamente tipado
    def propoe(self, lance: Lance):
        #esse -1 pega o ultimo lance
        ...
        #se tirar esse else da erro na exceção

    @property
    def lances(self):
        #vai devolver cópia da lista [:]
        #e pra passar o append, tem q passar pelo metodo propoe e nao ir na mao
